package com.ny.ane
{
	...
	[Event(name="ane_sysc_event", type="com.ny.ane.ANESyncEvent")]
	public class ANEHelper extends EventDispatcher
	{
		...
		private static const EXTENSION_ID:String ="com.ny.ANEManager";
		private var callBack:Function;
		
		public var nySDK:NYSDKInterface;
		...
		private function initExtContext():void{
			if(extContext==null){
				...
				nySDK = new NYSDKInterface(extContext);
			}
		}
