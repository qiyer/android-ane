...
public class ANEadFloatWinAdd implements FREFunction {
	...
	public FREObject call(FREContext context,FREObject[] arg1) {
		...
		FREObject b = null;
		Log.i("ANE", "ANEadFloatWinAdd");
		Tool.adFloatWinAdd(_context.getActivity(), new Listener() {
			@Override
		...
		_context.dispatchStatusEventAsync("ANEadFloatWinAdd","success");
		return b;
	}
